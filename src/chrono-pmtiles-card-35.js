...
// --- Version History ---------------------------------------------------------
// v0.1.35: Security: removed a real, internet-reachable Home Assistant
//          instance address that was hardcoded as DEFAULT_PMTILES_URL (used
//          as the example pmtiles_url in getStubConfig()). Replaced with the
//          generic relative placeholder "/local/my-map.pmtiles".
...
// v0.1.35: generic placeholder only -- used as the example pmtiles_url in
// getStubConfig() (card picker). Must never contain a real instance address.
const DEFAULT_PMTILES_URL = '/local/my-map.pmtiles';
